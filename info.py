...
PICS = (environ.get('PICS', 'https://graph.org/file/781443dcf49ff6bda5e4d.jpg')).split() #SAMPLE PIC
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002610916653').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002084178875') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://usescrypto50:jbcYFDyISQO6ZNYb@cluster0.ehawuqc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "usescrypto50")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'kannada_kid') # owner username without @
...
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'shortxlinks')
SHORTLINK_API = environ.get('SHORTLINK_API', 'b76f67cf7284707d3211dd48fed23111fe56da7a')
